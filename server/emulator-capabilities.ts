...
export const EMULATOR_ROOM_CAPABILITIES: Record<RoomSystem, EmulatorRoomCapability> = {
  nes: {
    ...
    note: "Famicom/NES: exactly 2 active-player seats and up to 6 spectators; the game core remains two-controller.",
  },
  ps1: {
    system: "ps1", coreName: "PCSX-ReARmed", maxRoomMembers: roomMemberLimit("ps1"), defaultControllerSeats: 2, maxControllerSeats: 4,
    netplay: "retroarch", maxPlayers: ROOM_CAPACITIES.ps1.maxPlayers, maxSpectators: ROOM_CAPACITIES.ps1.maxSpectators,
    note: "Up to 4 active players and 4 spectators; actual controller ports remain game-dependent.",
  },
  psp: {
    system: "psp", coreName: "PPSSPP", maxRoomMembers: roomMemberLimit("psp"), defaultControllerSeats: 2, maxControllerSeats: 4,
    netplay: "psp-network", maxPlayers: ROOM_CAPACITIES.psp.maxPlayers, maxSpectators: ROOM_CAPACITIES.psp.maxSpectators,
    note: "Up to 4 active players and 4 spectators; actual network/controller limits remain game-dependent.",
  },
  sega: {
    system: "sega", coreName: "Genesis Plus GX", maxRoomMembers: roomMemberLimit("sega"), defaultControllerSeats: 2, maxControllerSeats: 4,
    netplay: "retroarch", maxPlayers: ROOM_CAPACITIES.sega.maxPlayers, maxSpectators: ROOM_CAPACITIES.sega.maxSpectators,
    note: "Up to 4 active players and 4 spectators when the game supports four controllers; otherwise use fewer player seats.",
  },
};
