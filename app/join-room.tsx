...
const styles = StyleSheet.create({
  ...
  label: { color: "#EDE7FB", fontSize: 14, fontWeight: "900", textAlign: "left", marginBottom: 8, marginTop: 5 },
  ...
  roleCard: { flex: 1, minHeight: 103, padding: 12, borderRadius: 17, borderWidth: 1, borderColor: "#302044", backgroundColor: "#110A20", alignItems: "flex-start", justifyContent: "space-between" },
  ...
  roleText: { color: "#9E95AF", fontSize: 10, textAlign: "left", marginTop: 3 },
  ...
  createPrivateButton: { minHeight: 48, borderRadius: 15, marginTop: 10, alignItems: "center", justifyContent: "center", flexDirection: "row", gap: 8, borderWidth: 1, borderColor: "#356482", backgroundColor: "#0E2132" },
  createPrivateText: { color: "#A8F1FF", fontSize: 11, fontWeight: "900" },
  helper: { marginTop: 20, flexDirection: "row", gap: 8, alignItems: "flex-start", paddingHorizontal: 9 },
  helperText: { color: "#B6AEC6", fontSize: 11, lineHeight: 17, textAlign: "left", flex: 1 },
