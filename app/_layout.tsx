...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    try { initManusRuntime(); } catch (error) { console.warn("Optional preview runtime initialization failed.", error); }
  }, []);
  ...
  const themedContent = shouldOverrideSafeArea ? (
    ...
    <ThemeProvider><SafeAreaProvider initialMetrics={providerInitialMetrics}>{content}</SafeAreaProvider></ThemeProvider>
  );
