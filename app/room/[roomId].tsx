...
const styles = StyleSheet.create({
  ...
  system: { color: "#62C2EB", fontSize: 13, letterSpacing: 1, fontWeight: "900", textAlign: "left", marginTop: 26 }, title: { color: "#F3F7FB", fontSize: 30, lineHeight: 39, fontWeight: "800", textAlign: "left", marginTop: 4 }, caption: { color: "#9BAFC4", fontSize: 14, textAlign: "left", marginTop: 4 },
