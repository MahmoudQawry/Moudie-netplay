    ...
    <ScreenContainer className="px-5" edges={["top", "bottom", "left", "right"]} containerClassName="bg-background">
      ...
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.panel}>
          ...
          <Text style={styles.panelText}>Choose a legal game file stored on your device. Moudie never uploads your game or BIOS. Inside the game, tap EDIT to drag controls, use SIZE − / + or pinch to resize them, and save independent layouts for portrait and landscape.</Text>
